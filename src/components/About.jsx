    ...
    <section className={styles["about-section"]} id="about">
      ...
      <div className={styles["about-content"]}>
        ...
        <p className={styles["about-description"]}>
          ...
          and frameworks such as React. Strong ability to turn designs into code
          and collaborate with cross-functional teams to deliver high-quality
          projects on time. Adept in optimizing website performance, ensuring
          cross-browser compatibility, and ensuring accessibility standards are
          met"
        </p>
      </div>
    </section>
